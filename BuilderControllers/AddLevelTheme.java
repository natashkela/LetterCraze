 ...
 * */
public class AddLevelTheme extends JPanel {
	 ...
	 * Create the panel.
	 */
	public AddLevelTheme(SplashScreen2 first) {
		this.bla=first;
		setLayout(null);
		
		JLabel lblLevelBuilder = new JLabel("Level Builder For Theme");
		lblLevelBuilder.setBounds(256, 5, 149, 16);
		add(lblLevelBuilder);
		...
		textField_3.setBounds(240, 214, 130, 26);
		add(textField_3);
		...
		JLabel lblNumberOfSeconds = new JLabel("Theme Name");
		lblNumberOfSeconds.setBounds(240, 195, 88, 16);
		add(lblNumberOfSeconds);
		
		JLabel lblEnterLettersThat = new JLabel("Enter Letters that you want in the theme separated by commas");
		lblEnterLettersThat.setBounds(240, 261, 395, 16);
		add(lblEnterLettersThat);
		
		textField_4 = new JTextField();
		textField_4.setBounds(240, 289, 398, 26);
		add(textField_4);
