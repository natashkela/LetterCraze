 ...
 * */
public class AddLevelPuzzle extends JPanel {
	 ...
	 * Create the panel.
	 */
	public AddLevelPuzzle(SplashScreen2 first) {
		this.bla=first;
		setLayout(null);
		
		JLabel lblLevelBuilder = new JLabel("Level Builder For Puzzle");
		lblLevelBuilder.setBounds(256, 5, 147, 16);
		add(lblLevelBuilder);
		...
		lblNumberOfMoves.setBounds(240, 195, 165, 16);
