...
/*
 * Lightening level that shows the table with letters
 ...
 * */
public class LighteningLevel extends JPanel {
	SplashScreen1 bla;//just named it bla cause of no reaosn
	/**
	 * Create the panel.
	 */
	public LighteningLevel(SplashScreen1 first) {
		...
		lblTime.setBounds(6, 364, 67, 16);
		add(lblTime);
		
		JLabel lblLevelYouSelected = new JLabel("Lightening");
		lblLevelYouSelected.setBounds(286, 50, 125, 16);
		add(lblLevelYouSelected);
		
		JLabel lblMovesRemaining = new JLabel("Time left: 120 Seconds");
		lblMovesRemaining.setBounds(6, 329, 144, 16);
		add(lblMovesRemaining);
		
		JLabel lblNumberOfStars = new JLabel("Number of Stars: 0 out of 3");
		lblNumberOfStars.setBounds(6, 291, 172, 16);
		add(lblNumberOfStars);
		
		JLabel lblWordsFound = new JLabel("Words Found: ");
		lblWordsFound.setBounds(546, 50, 92, 16);
		add(lblWordsFound);
	}
